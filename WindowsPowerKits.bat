...
SET "texttools=.\functions\texttools.bat"
SET "ver=0.2.0"
...
IF NOT EXIST "%texttools%" GOTO ERR_TEXT
CALL "%ui%" init
...
GOTO :EOF
:ERR_TEXT
CALL :ERROR FILE_NOT_FOUND "找不到文件: %texttools%"
GOTO :EOF
...
ECHO  !CYAN!│!R!   !BOLD!!WHITE!██║███╗██║██╔═══╝ ██╔═██╗ !R!     !CYAN!│!R!   !GREEN!2!R!  文本工具                             !CYAN!│!R!
